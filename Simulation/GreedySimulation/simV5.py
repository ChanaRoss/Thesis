...
def main():
    ...
    if flagLoadParam == 1:
        pickleName = 'log_Cost_WaitTime_CarMovement_7grid_2cars_40simLengh_50StochasticLength_3Prediction_2aStarWeight'
        ...
        if len(filteredEvents) == 0:
            ...
            for cid in carDict:
                if carDict[cid]['target'] is not None:
                    carDict[cid],totalCost = moveCar(carDict[cid], timeLine[timeIndex + 1] - timeLine[timeIndex],totalCost)
