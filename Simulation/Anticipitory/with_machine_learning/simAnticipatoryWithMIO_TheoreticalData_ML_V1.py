...
def main():
    ...
    # data loader -
    dataPath = '/Users/chanaross/dev/Thesis/ProbabilityFunction/theoreticalProbability/'
    netPath = '/Users/chanaross/dev/Thesis/MachineLearning/forGPU/GPU_results/theoreticalResults/'
    fileNameNetwork = 'theoretical_seq_20_bs_20_hs_64_lr_0.01_ot_2_wd_0.001_torch.pkl'
    ...
    simStartTime                = 10     # time from which to start looking at the data
