...
def optimizedSimulation(initialState, fileLoc, fileName, gridSize):
    ...
    dataOut = plotResults(m, carsPos, np.array(eventsPos), np.array(eventsStartTime), np.array(eventsEndTime),
...
def main():
    ...
    pickleName  = 'SimAnticipatory_bruteForce_MioFinalResults_4lpred_50startTime_10gridX_20gridY_42numEvents_1nStochastic_4numCars_NN'
    ...
    if loadFromPickle:
        ...
        fileName = '4lpred_50startTime_10gridX_20gridY_42numEvents_1nStochastic_4numCars_Bm'
