...
pickleNames.append('HungarianMethodlog_Cost_WaitTime_CarMovement_7grid_2cars_40simLengh_50StochasticLength_3Prediction_2aStarWeight')
# pickleNames.append('MyAStarResult_1_weight2numCars_15numEvents_7gridSize')
...
def main():
    ...
    for pickleName in pickleNames:
        ...
        if 'AStar' in pickleName:
            ...
            cost = calcTotalCost(lg,simTime,numEventsClosed)
            print('total cost is : '+str(cost))
            print('total cost from file is:'+str(lg['cost']))
    plt.show()
