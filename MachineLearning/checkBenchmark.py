...
def main():
    ...
    fileNameReal = '3D_allDataLatLonCorrected_binaryClass_500gridpickle_30min.p'
    # fileNameReal = '4D_matPerWeek_allDataLatLonCorrected_binaryClass_500gridpickle_30min.p'
    fileNameDist = '4D_ProbabilityMat_allDataLatLonCorrected_binaryClass_CDF_500gridpickle_30min.p'
    ...
    # dataInputRealFull.dump('/Users/chanaross/dev/Thesis/UberData/3D_allDataLatLonCorrected_binaryClass_500gridpickle_30min.p')
    ...
    timeOut = []
    numRuns = 100
    fileNameOut = '500grid_30min_binary_benchmark_results_random_' + numRuns
