...
def calc_netOutput_fromData(data_in, my_net, timeIndexs):
    ...
    for i, t in enumerate(timeIndexs):
        ...
        net_output[i, :, :] = net_labelsNp.reshape([x_size, y_size])
        label_output[i, :, :] = labelsNp.reshape([x_size, y_size])
...
def main():
    ...
    for network_name in network_names:
        ...
        if plot_from_probability:
            ...
            net_output_fromData, label_output_fromData, net_results = calc_netOutput_fromData(dataInputReal,my_net,
                                                                                                          timeIndexs)
