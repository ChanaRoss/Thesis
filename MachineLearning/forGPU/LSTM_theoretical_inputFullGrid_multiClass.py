...
def main():
    ...
    fileName = '3Dmat_theoreticalData_2_mu_3_sigma_0.1_smallCoeff.p'
    ...
    for i in itr:
        networkStr = 'theoretical_seq_{0}_bs_{1}_hs_{2}_lr_{3}_ot_{4}_wd_{5}'.format(i[0], i[1], i[2], i[3], i[4], i[5])
        networksDict[networkStr] = {'seq': i[0], 'bs': i[1], 'hs': i[2], 'lr': i[3], 'ot': i[4], 'wd': i[5]}

    for netConfig in networksDict:
        dataInputSmooth = dataInput
