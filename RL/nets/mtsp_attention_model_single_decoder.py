...
class MultiAttentionModelSingleDecoder(nn.Module):
    ...
    def __init__(self,
        ...
        super(MultiAttentionModelSingleDecoder, self).__init__()
    ...
    def _inner(self, input_data, embeddings):
        ...
        while not (self.shrink_size is None and state.all_finished()):
            ...
            for i_c in range(self.n_cars):
                ...
                log_p_per_car = self.decoder(state, fixed, embeddings, i_c)
